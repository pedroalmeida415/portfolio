      ...
      */}
      ...
      <body>
        ...
        function ScrollSmoother(t) {
          var o = this
          L || ScrollSmoother.register(I) || console.warn('Please gsap.registerPlugin(ScrollSmoother)'),
            (t = this.vars = t || {}),
            J && J.kill(),
            X((J = this))
          function Aa() {
          ...
          function Ja(e) {
            ;(S.scrollTop = 0),
              (e.target.contains && e.target.contains(S)) ||
                (T && !1 === T(o, e)) ||
                (V.isInViewport(e.target) || e.target === g || o.scrollTo(e.target, !1, 'center center'),
                (g = e.target))
          }
          function Ka(t, e) {
                ...
                b.forEach(function (e) {
                  ...
                  e._startClamp && t < 0
                    ...
                    : (e.ratio < 0 || (e._endClamp && r >= v())) &&
                      (n =
                        ((r = v()) - (t = e.ratio < 0 || 1 < e.ratio ? 0 : r - (r - e.start) / e.ratio)) * e.ratio -
                        (e.end - e.start)),
                    (e.offset = n || 1e-4),
          ...
          function Ra(r, n, o, i) {
            return function () {
              ...
              e || 0 === e || (e = i.getAttribute('data-' + x + r) || ('speed' === r ? 1 : 0)),
                    ...
                    0 < c &&
                      ((n =
                        0.5 == (r = s.height / (U.innerHeight + s.height))
                          ? 2 * s.height
                          : 2 * Math.min(s.height, Math.abs((-c * r) / (2 * r - 1))) * (t || 1)),
                      (f += t ? -n * t : -n / 2),
                      (c += n)),
                    {
                      change: c,
          ...
          var n,
            ...
            P = V.getScrollFunc(U),
            k =
              1 === V.isTouch ? (!0 === p ? 0.8 : parseFloat(p) || 0) : 0 === _ || !1 === _ ? 0 : parseFloat(_) || 0.8,
            A = (k && +t.speed) || 1,
            H = 0,
            M = 0,
            N = 1,
              ...
              return arguments.length
                ? ((S =
                    ...
                    (function _wrap(e) {
                      ...
                      return (
                        t ||
                          ((t = G.createElement('div')).classList.add('ScrollSmoother-wrapper'),
          ...
          B.forEach(function (e) {
            ...
            (this.smooth = function (e) {
              return (
                arguments.length && ((A = ((k = e || 0) && +t.speed) || 1), i.scrubDuration(e)),
            ...
            t.effects &&
              this.effects(!0 === t.effects ? '[data-' + x + 'speed], [data-' + x + 'lag]' : t.effects, {
